...
\address{5239 Lake Road West \#405}{Saybrook}{Ohio}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
...
\section{Awards}
\cvlistitem{Dean’s List Fall 2012--Spring 2015}
\cvlistitem{Stony Brook Provost’s Scholarship Fall 2012--Spring 2016}

\section{Interests}
\cvitem{Security}{Censorship, NetSec, and Encryption}
\cvitem{Algorithms}{Cool and Fun Algorithms}
\cvitem{Data Structures}{Write Optimized Data Structures and Quotient Filters}
\cvitem{Puzzles}{DFA Puzzles, Logic Puzzles, Physics Puzzles, You Name It!}
\cvitem{Other}{Above are interests that I am formally acquainted with. However, most Computer Science topics interest me.}

\section{Experience}
\cventry{2015--Present}{Student Intern}{Sandia National Laboratories}{Livermore, CA}{}{%General description no longer than 1--2 lines.\newline{}%
...
\begin{cvcolumns}
	\hspace{-3cm}
  \cvcolumn{Professor}{Michael Bender\\Phillipa Gill\\ Rob Johnson}
  \cvcolumn{University}{Stony Brook\\ Stony Brook\\ Stony Brook}
  \cvcolumn[0.5]{Contact}{bender@cs.stonybrook.edu\\ phillipa@cs.stonybrook.edu\\ rob@cs.stonybrook.edu}
\end{cvcolumns}
